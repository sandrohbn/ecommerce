<?php if(!class_exists('Rain\Tpl')){exit;}?><!-- Declaração do formulário - abrindo nova aba 
<form method="post" target="pagseguro"  
action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
-->          
<!-- Declaração do formulário - abrindo na mesma aba -->
<form method="post" action="https://pagseguro.uol.com.br/v2/checkout/payment.html">

        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="sh.bbb@hotmail.com">  
        ...
        <!-- submit do form (obrigatório) - Substituido por javascript no final do formulario 
